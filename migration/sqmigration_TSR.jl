function sqmigration_TSR(m,s,h,hN,σ,Rm,K,xD,yD,ϵ,ν,μ,β,ξ,width,height,D,pmig,area_approx,preexisting,T,test_threshold,Gauss,terminate_resistance)
...
# equivalent circular deme
    ...
    return (x,y,popsize,resistance,τ,xnum,ynum)
