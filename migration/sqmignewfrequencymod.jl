function sqmignewfrequency(Rm,α,xold,yold,μ,Wf,Wm,na,ψ,mutmatrix,κ,Nf,Nm,Gauss,parallel,pmig)
    ...
    for kkkk = 1:na
        ...
        B_x[:,:,kkkk] = square_deme_migration(A_x,pmig,Gauss,parallel);
        B_y[:,:,kkkk] = square_deme_migration(A_y,pmig,Gauss,parallel);
    end
    #print(7)
