function sqmigration_TSR(m,s,h,hN,σ,Rm,K,xD,yD,ϵ,ν,μ,β,ξ,width,height,D,pmig,area_approx,preexisting,T,test_threshold,Gauss,parallel,terminate_resistance)
